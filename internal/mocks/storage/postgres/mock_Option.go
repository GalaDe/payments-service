...
import (
	postgres "github.com/GalaDe/payments-service/internal/storage/postgres"
...
func (_m *MockOption) Execute(_a0 *postgres.Postgres) {
	_m.Called(_a0)
}
...
func (_c *MockOption_Execute_Call) Run(run func(_a0 *postgres.Postgres)) *MockOption_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*postgres.Postgres))
	})
	return _c
}
...
func (_c *MockOption_Execute_Call) RunAndReturn(run func(*postgres.Postgres)) *MockOption_Execute_Call {
	_c.Run(run)
	return _c
}
