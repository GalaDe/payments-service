...
func (_m *MockClient) DeploymentClient() internal.DeploymentClient {
	ret := _m.Called()
...
func (_c *MockClient_DeploymentClient_Call) Return(_a0 internal.DeploymentClient) *MockClient_DeploymentClient_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClient_DeploymentClient_Call) RunAndReturn(run func() internal.DeploymentClient) *MockClient_DeploymentClient_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClient) NewWithStartWorkflowOperation(options client.StartWorkflowOptions, workflow interface{}, args ...interface{}) internal.WithStartWorkflowOperation {
	var _ca []interface{}
	...
	if rf, ok := ret.Get(0).(func(client.StartWorkflowOptions, interface{}, ...interface{}) internal.WithStartWorkflowOperation); ok {
...
func (_c *MockClient_NewWithStartWorkflowOperation_Call) Return(_a0 internal.WithStartWorkflowOperation) *MockClient_NewWithStartWorkflowOperation_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClient_NewWithStartWorkflowOperation_Call) RunAndReturn(run func(client.StartWorkflowOptions, interface{}, ...interface{}) internal.WithStartWorkflowOperation) *MockClient_NewWithStartWorkflowOperation_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClient) UpdateWithStartWorkflow(ctx context.Context, options internal.UpdateWithStartWorkflowOptions) (client.WorkflowUpdateHandle, error) {
	ret := _m.Called(ctx, options)
	...
	var r0 client.WorkflowUpdateHandle
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, internal.UpdateWithStartWorkflowOptions) (client.WorkflowUpdateHandle, error)); ok {
		return rf(ctx, options)
	}
	if rf, ok := ret.Get(0).(func(context.Context, internal.UpdateWithStartWorkflowOptions) client.WorkflowUpdateHandle); ok {
		r0 = rf(ctx, options)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(client.WorkflowUpdateHandle)
...
func (_c *MockClient_UpdateWithStartWorkflow_Call) Run(run func(ctx context.Context, options internal.UpdateWithStartWorkflowOptions)) *MockClient_UpdateWithStartWorkflow_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClient_UpdateWithStartWorkflow_Call) RunAndReturn(run func(context.Context, internal.UpdateWithStartWorkflowOptions) (client.WorkflowUpdateHandle, error)) *MockClient_UpdateWithStartWorkflow_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockClient) UpdateWorkflow(ctx context.Context, options internal.UpdateWorkflowOptions) (client.WorkflowUpdateHandle, error) {
	ret := _m.Called(ctx, options)
	...
	var r0 client.WorkflowUpdateHandle
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, internal.UpdateWorkflowOptions) (client.WorkflowUpdateHandle, error)); ok {
		return rf(ctx, options)
	}
	if rf, ok := ret.Get(0).(func(context.Context, internal.UpdateWorkflowOptions) client.WorkflowUpdateHandle); ok {
		r0 = rf(ctx, options)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(client.WorkflowUpdateHandle)
...
func (_c *MockClient_UpdateWorkflow_Call) RunAndReturn(run func(context.Context, internal.UpdateWorkflowOptions) (client.WorkflowUpdateHandle, error)) *MockClient_UpdateWorkflow_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateWorkflowExecutionOptions provides a mock function with given fields: ctx, options
func (_m *MockClient) UpdateWorkflowExecutionOptions(ctx context.Context, options internal.UpdateWorkflowExecutionOptionsRequest) (internal.WorkflowExecutionOptions, error) {
	ret := _m.Called(ctx, options)
...
func (_c *MockClient_UpdateWorkflowExecutionOptions_Call) Run(run func(ctx context.Context, options internal.UpdateWorkflowExecutionOptionsRequest)) *MockClient_UpdateWorkflowExecutionOptions_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClient_UpdateWorkflowExecutionOptions_Call) Return(_a0 internal.WorkflowExecutionOptions, _a1 error) *MockClient_UpdateWorkflowExecutionOptions_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockClient_UpdateWorkflowExecutionOptions_Call) RunAndReturn(run func(context.Context, internal.UpdateWorkflowExecutionOptionsRequest) (internal.WorkflowExecutionOptions, error)) *MockClient_UpdateWorkflowExecutionOptions_Call {
	_c.Call.Return(run)
	return _c
}

// WorkerDeploymentClient provides a mock function with no fields
func (_m *MockClient) WorkerDeploymentClient() internal.WorkerDeploymentClient {
	ret := _m.Called()
...
func (_c *MockClient_WorkerDeploymentClient_Call) Return(_a0 internal.WorkerDeploymentClient) *MockClient_WorkerDeploymentClient_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClient_WorkerDeploymentClient_Call) RunAndReturn(run func() internal.WorkerDeploymentClient) *MockClient_WorkerDeploymentClient_Call {
	_c.Call.Return(run)
	return _c
}
